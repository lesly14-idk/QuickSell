...
(
	...
	direccion_usuario VARCHAR(150) not null, --domicilio
	email_usuario VARCHAR(100) not null UNIQUE,
	contraseña_usuario VARCHAR(255) not null, --eso no estaba en el diagrama pero deberia xd
	estado_usuario VARCHAR(50) not null CHECK (estado_usuario IN ('Activo', 'Inactivo', 'Suspendido')), --estatus
...
(
	...
	rfc_empresa VARCHAR(10) not null UNIQUE, --numero fiscal
...
--- CORREGIDO ESA PARTE DE  LA TABLA

--agrega los valores (el auto incrementado no se agrega) --> id_proveedor
INSERT INTO PROVEEDORES (id_usuario, nombre_empresa, rfc_empresa, catalogo_activo, validado_por_admin, fecha_validacion)
VALUES
(2, 'Electronic', '1234567890','TRUE', 'TRUE', GETDATE()),
(4, 'Accessory Aesthethic', '0987654321' , 'TRUE', 'TRUE', GETDATE()),
(5, 'Mens Boutique', '1357924680' , 'TRUE', 'TRUE', GETDATE())
...
VALUES
(2, 3, 2, 5999.99), --Traje vaquero --2 ID: 8 -- 3--> ID_PROD: 5
(1, 1, 3, 28800.00 ) --laptop --1 ID: 9		--> 1-->ID_prod: 3
...
VALUES
(1, 'mercadoPago', 8500.00, 'pendiente', 'TRUE'), --8   --> ID: 1
(2, 'mercadoPago', 6000.00, 'Validado', 'TRUE') --9   --> ID: 2
...
--ESTOS YA SE INSERTARON CORRECTAMENTE
...
VALUES
(1, 'Local', 'Las Puentes', 'GUI001234', 'Preparacion'),  -- ID: 8  --> 1
(2, 'Autogestionado', 'Las Puentes', 'TRK567890', 'En transito') -- ID: 9 --> 2
